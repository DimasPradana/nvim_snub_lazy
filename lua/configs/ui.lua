...
api.nvim_exec(
  ...
  au WinEnter,BufEnter,FileType filesystem setlocal statusline=%!v:lua.Statusline('explorer')
  au WinEnter,BufEnter,FileType neo-tree setlocal statusline=%!v:lua.Statusline('inactive')
  au WinLeave,BufLeave * setlocal statusline=%!v:lua.Statusline('inactive')
  augroup END
]],
  false
